    ...
    <div style={styles.container}>
      ...
      <aside style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          ...
          <div style={styles.navItemActiveSim} onClick={() => navigate('/scanner-facial')}>👤 Scanner Facial</div>
          <div style={styles.navItemSim} onClick={() => navigate('/scanner-qr')}>🎫 Scanner QR</div>
        </nav>
